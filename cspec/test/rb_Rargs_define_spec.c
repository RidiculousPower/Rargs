...
DESCRIBE( R_HashKeyData, "R_Hash( R_Key( possible_match ), R_Data( possible_match ) )" )
	IT( "takes a key and data, each of which can be any type of possible match" )
		rarg_possible_hash_key_data_match_t* key_possible_match = R_Key( R_Any() );
		//	make sure we got a struct back
		...
		rarg_possible_hash_key_data_match_t* data_possible_match = R_Data( R_Any() );
...
DESCRIBE( R_Index, "R_Index( index_name )" )
...
DESCRIBE( R_BlockProc, "R_BlockProc()" )
...
DESCRIBE( R_BlockLambda, "R_BlockLambda()" )
	IT( "takes no arguments and looks for a block to be present" )
...
DESCRIBE( R_BlockProcWithArity, "R_BlockProcWithArity( arity, ... )" )
...
DESCRIBE( R_BlockLambdaWithArity, "R_BlockLambdaWithArity( arity, ... )" )
	IT( "takes arities and looks for a block with one of given arities to be present" )
...
DESCRIBE( R_RespondsTo, "R_RespondsTo( ancestor_name, ... )" )
...
DESCRIBE( R_Returns, "R_Returns( method_name, rb_return_value, ... )" )
...
DESCRIBE( R_ReturnsWithArgs, "R_ReturnsWithArgs( method_name, argc, args, rb_return_value, ... )" )
...
DESCRIBE( R_ReturnsNonNil, "R_ReturnsNonNil( method_name, ... )" )
...
DESCRIBE( R_ReturnsNonNilWithArgs, "R_ReturnsNonNilWithArgs( method_name, argc, args )" )
...
DESCRIBE( R_Parameter, "R_ParameterSet( parameter_set, ... )" )
	IT( "takes a method name C string, argc, args (VALUE*), and any number of Ruby return values and tests whether method return matches one of return values" )
...
DESCRIBE( R_ParameterSet, "R_ParameterSet( parameter_set, ... )" )
	IT( "takes a method name C string, argc, args (VALUE*), and any number of Ruby return values and tests whether method return matches one of return values" )
		rarg_possible_match_t* possible_match = R_Any();
		rarg_parameter_t* parameter = R_Parameter( possible_match );
...
DESCRIBE( R_ExactMatch, "R_ExactMatch( parameter_set, ... )" )
...
DESCRIBE( R_Group, "R_Group( possible_match, ... )" )
...
DESCRIBE( R_MatchIndexMatch, "R_MatchIndexMatch( index_string, possible_match, receiver )" )
...
DESCRIBE( R_MatchPossibleTypeForHash, "R_MatchPossibleTypeForHash( receiver )" )
...
DESCRIBE( R_Optional, "R_OptionalParameter( parameter ); R_OptionalMatch( possible_match )" )
...
DESCRIBE( R_Describe, "R_DescribeParameterSet( \"\", ... ); R_DescribeParameter( \"\", ... ); R_DescribePossibleMatch( \"\", ... );" )
...
void rb_Rargs_define_spec( void )	{
	...
	CSpec_Run( DESCRIPTION( R_HashKeyData ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_Index ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_BlockProc ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_BlockLambda ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_BlockProcWithArity ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_BlockLambdaWithArity ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_IfElse ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_RespondsTo ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_Returns ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_ReturnsWithArgs ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_ReturnsNonNil ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_ReturnsNonNilWithArgs ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_Parameter ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_ParameterSet ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_ExactMatch ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_Group ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_MatchType ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_MatchIndex ), CSpec_NewOutputVerbose() );
	...
	CSpec_Run( DESCRIPTION( R_Optional ), CSpec_NewOutputVerbose() );
	CSpec_Run( DESCRIPTION( R_Describe ), CSpec_NewOutputVerbose() );
