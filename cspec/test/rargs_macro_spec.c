...
DESCRIBE( R_Type, "R_Type( type, ... )" )
  IT( "checks an argument for its type" )    
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_nil,
                        rarg_parse_descriptor_for_nil,      
                        argc, 
                        args_for_nil,          
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Nil() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_nil->args_parsed );
    
    //  true
    
    VALUE  args_for_true[]  =  { Qtrue };
    RI_DefineAndParse(  rarg_parameter_sets_for_true,
                        rarg_parse_descriptor_for_true,      
                        argc, 
                        args_for_true,          
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_True() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_true->args_parsed );

    //  false

    VALUE  args_for_false[]  =  { Qfalse };
    RI_DefineAndParse(  rarg_parameter_sets_for_false,
                        rarg_parse_descriptor_for_false,      
                        argc, 
                        args_for_false,          
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_False() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_false->args_parsed );

    //  class

    VALUE  args_for_class[]  =  { rb_cObject };
    RI_DefineAndParse(  rarg_parameter_sets_for_class,      
                        rarg_parse_descriptor_for_class,      
                        argc, 
                        args_for_class,          
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Class() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_class->args_parsed );

    //  module

    VALUE  args_for_module[]  =  { rb_mEnumerable };
    RI_DefineAndParse(  rarg_parameter_sets_for_module,    
                        rarg_parse_descriptor_for_module,   
                        argc, 
                        args_for_module,       
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Module() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_module->args_parsed );

    //  string

    VALUE  args_for_string[]  =  { rb_str_new2( "string" ) };
    RI_DefineAndParse(  rarg_parameter_sets_for_string,    
                        rarg_parse_descriptor_for_string,   
                        argc, 
                        args_for_string,      
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_String() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_string->args_parsed );

    //  symbol

    VALUE  args_for_symbol[]  =  { ID2SYM( rb_intern( "symbol" ) ) };
    RI_DefineAndParse(  rarg_parameter_sets_for_symbol,    
                        rarg_parse_descriptor_for_symbol,   
                        argc, 
                        args_for_symbol,      
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Symbol() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_symbol->args_parsed );

    //  array

    VALUE  args_for_array[]  =  { rb_ary_new() };
    RI_DefineAndParse(  rarg_parameter_sets_for_array,      
                        rarg_parse_descriptor_for_array,    
                        argc, 
                        args_for_array,        
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Array() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_array->args_parsed );

    //  hash

    VALUE  args_for_hash[]  =  { rb_hash_new() };
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,      
                        rarg_parse_descriptor_for_hash,    
                        argc, 
                        args_for_hash,        
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Type( R_HASH ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_hash->args_parsed );

    //  fixnum

    VALUE  args_for_fixnum[]  =  { INT2FIX( 1 ) };
    RI_DefineAndParse(  rarg_parameter_sets_for_fixnum,    
                        rarg_parse_descriptor_for_fixnum,   
                        argc, 
                        args_for_fixnum,      
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_FixNum() ) ) );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_data,      
                        rarg_parse_descriptor_for_data,     
                        argc, 
                        args_for_data,        
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Data() ) ) );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_file,      
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_File() ) ) );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_regexp,    
                        rarg_parse_descriptor_for_regexp,   
                        argc, 
                        args_for_regexp,      
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Regexp() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_regexp->args_parsed );

    //  match

    VALUE  args_for_match[]    =  { rb_eval_string( "/regexp/.match( 'regexp' )" ) };
    RI_DefineAndParse(  rarg_parameter_sets_for_match,      
                        rarg_parse_descriptor_for_match,    
                        argc, 
                        args_for_match,        
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_RegexpMatch() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_match->args_parsed );

    //  object

    VALUE  args_for_object[]  =  { rb_eval_string( "Object.new" ) };
    RI_DefineAndParse(  rarg_parameter_sets_for_object,    
                        rarg_parse_descriptor_for_object,   
                        argc, 
                        args_for_object,      
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Object() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_object->args_parsed );

    //  float

    VALUE  args_for_float[]  =  { rb_eval_string( "42.420" ) };
    RI_DefineAndParse(  rarg_parameter_sets_for_float,      
                        rarg_parse_descriptor_for_float,    
                        argc, 
                        args_for_float,       
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Float() ) ) );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_bignum,    
                        rarg_parse_descriptor_for_bignum,   
                        argc, 
                        args_for_bignum,      
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_BigNum() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_bignum->args_parsed );

    //  rational

    VALUE  args_for_rational[]  =  { rb_eval_string( "Rational( 42, 420 )" ) };
    RI_DefineAndParse(  rarg_parameter_sets_for_rational,  
                        rarg_parse_descriptor_for_rational, 
                        argc, 
                        args_for_rational,    
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Rational() ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_rational->args_parsed );

    //  complex

    VALUE  args_for_complex[]  =  { rb_eval_string( "Complex( 42, 420 )" ) };
    RI_DefineAndParse(  rarg_parameter_sets_for_complex,    
                        rarg_parse_descriptor_for_complex,  
                        argc, 
                        args_for_complex,      
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Complex() ) ) );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_struct,  
                        rarg_parse_descriptor_for_struct,   
                        argc, args_for_struct,      
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Struct() ) ) );
...
DESCRIBE( R_MatchType, "R_MatchType( receiver, type )" )
  IT( "checks an argument for its type and assigns match to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_nil,        
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchNil( rb_nil_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_nil->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_true,
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchTrue( rb_true_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_true->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_false,
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchFalse( rb_false_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_false->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_class,      
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchClass( rb_class_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_class->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_module,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchModule( rb_module_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_module->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_string,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchString( rb_string_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_string->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_symbol,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchSymbol( rb_symbol_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_symbol->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_array,      
                        ...
                        rb_self,
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchArray( rb_array_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_array->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,      
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchArray( rb_hash_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_hash->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_fixnum,    
                        ...
                        args_for_fixnum,      
                        rb_self, 
                        FALSE, R_ParameterSet( R_Parameter( R_MatchFixNum( rb_fixnum_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_fixnum->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_data,      
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchData( rb_data_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_data->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_file,      
                        ...
                        rb_self,
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchFile( rb_file_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_file->args_parsed );
    rb_io_close( rb_file );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_regexp,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchRegexp( rb_regexp_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_regexp->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_match,      
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchRegexpMatch( rb_match_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_match->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_object,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchObject( rb_object_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_object->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_float,      
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchFloat( rb_float_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_float->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_bignum,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchBigNum( rb_bignum_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_bignum->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_rational,  
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchRational( rb_rational_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_rational->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_complex,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchComplex( rb_complex_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_complex->args_parsed );
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_struct,    
                        ...
                        rb_self,
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchStruct( rb_struct_match ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_struct->args_parsed );
...
DESCRIBE( R_MatchPossibleType, "R_MatchPossibleType( receiver, possible_match )" )
  IT( "checks possible match against argument and assigns match to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_possible_type,    
                        rarg_parse_descriptor_for_possible_type,  
                        argc, 
                        args_for_complex,      
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchPossibleType( rb_possible_match, R_Complex() ) ) ) );
...
DESCRIBE( R_MatchPossibleTypeForHash, "R_MatchPossibleTypeForHash( receiver, possible_match )" )
  IT( "checks possible match against hash key/data argument and assigns match to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Hash(  R_HashKey( R_Symbol() ),
...
DESCRIBE( R_MatchRespondsTo, "R_MatchRespondsTo( receiver, method, ... )" )
  IT( "matches if arg responds to named method and assigns match to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_responds_to,    
                        rarg_parse_descriptor_for_responds_to,  
                        argc,
                        args_for_responds_to,  
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchRespondsTo( rb_method_match, "methods" ) ) ) );    
...
DESCRIBE( R_MatchReturns, "R_MatchReturns( receiver, method, rb_return_value, ... )" )
  IT( "matches if named method return matches rb_return_value and assigns match to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,    
                        rarg_parse_descriptor_for_returns,  
                        argc, 
                        args_for_returns_match,  
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchReturns( rb_method_returns_match, "superclass", rb_cBasicObject ) ) ) );    
...
DESCRIBE( R_MatchReturnsWithArgs, "R_MatchReturnsWithArgs( receiver, method, argc, args, rb_return_value, ... )" )
  IT( "matches if named method returns matches rb_return_value when passed given args and assigns match to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchReturnsWithArgs( rb_method_returns_match, "[]", 1, & rb_index, rb_array_contents ) ) ) );    
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_returns->args_parsed );    
...
DESCRIBE( R_MatchReturnsNonNil, "R_MatchReturnsNonNil( receiver, method, ... )" )
  IT( "matches if named method returns non-nil and assigns match to receiver" )
    ...
    VALUE  rb_method_match  =  Qnil;
    RI_DefineAndParse(  rarg_parameter_sets_for_returns,    
                        rarg_parse_descriptor_for_returns,  
                        argc, 
                        args_for_returns,  
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchReturnsNonNil( rb_method_match, "methods" ) ) ) );    
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_returns->args_parsed );    
    SHOULD_EQUAL( rb_method_match, rb_cObject );
  END_IT
END_DESCRIBE
...
DESCRIBE( R_MatchReturnsNonNilWithArgs, "R_MatchReturnsNonNilWithArgs( receiver, method, argc, args )" )
  IT( "matches if named method returns returns non-nil when passed given args and assigns match to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchReturnsNonNilWithArgs( rb_method_returns_match, "[]", 1, & rb_index ) ) ) );    
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_returns->args_parsed );    
    SHOULD_EQUAL( rb_method_returns_match, rb_call_object );
  END_IT
END_DESCRIBE
...
/*************************************************************
*  R_MatchObjectRespondsTo( receiver, object, method, ... )  *
*************************************************************/

DESCRIBE( R_MatchObjectRespondsTo, "R_MatchObjectRespondsTo( receiver, object, method, ... )" )
  IT( "matches if arg responds to named method and assigns match to receiver" )
    VALUE  rb_self  =  rb_cObject;
    VALUE  argc    =  1;
    VALUE  args_for_responds_to[]  =  { rb_cObject };
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_responds_to,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchObjectRespondsTo( rb_method_match, rb_cObject, "methods" ) ) ) );    
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_responds_to->args_parsed );    
    SHOULD_EQUAL( rb_method_match, rb_cObject );
  END_IT
END_DESCRIBE
...
/***************************************************************************
*  R_MatchObjectReturns( receiver, object, method, rb_return_value, ... )  *
***************************************************************************/

DESCRIBE( R_MatchObjectReturns, "R_MatchObjectReturns( receiver, object, method, rb_return_value, ... )" )
  IT( "matches if named method return matches rb_return_value and assigns match to receiver" )
    VALUE  rb_self  =  rb_cObject;
    VALUE  argc    =  1;
    VALUE  args_for_returns_match[]  =  { rb_cObject };
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchObjectReturns( rb_method_returns_match, rb_cObject, "superclass", rb_cBasicObject ) ) ) );    
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_returns->args_parsed );    
    SHOULD_EQUAL( rb_method_returns_match, rb_cObject );
  END_IT
END_DESCRIBE
...
/***********************************************************************************************
*  R_MatchObjectReturnsWithArgs( receiver, object, method, argc, args, rb_return_value, ... )  *
***********************************************************************************************/

DESCRIBE( R_MatchObjectReturnsWithArgs, "R_MatchObjectReturnsWithArgs( receiver, object, method, argc, args, rb_return_value, ... )" )
  IT( "matches if named method returns matches rb_return_value when passed given args and assigns match to receiver" )
    VALUE  rb_self  =  rb_cObject;
    VALUE  argc    =  1;
    VALUE  rb_call_object  =  rb_ary_new();
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchObjectReturnsWithArgs( rb_method_returns_match, rb_call_object, "[]", 1, & rb_index, rb_array_contents ) ) ) );    
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_returns->args_parsed );    
    SHOULD_EQUAL( rb_method_returns_match, rb_call_object );
  END_IT
END_DESCRIBE
...
/****************************************************************
*  R_MatchObjectReturnsNonNil( receiver, object, method, ... )  *
****************************************************************/

DESCRIBE( R_MatchObjectReturnsNonNil, "R_MatchObjectReturnsNonNil( receiver, object, method, ... )" )
  IT( "matches if named method returns non-nil and assigns match to receiver" )
    VALUE  rb_self  =  rb_cObject;
    VALUE  argc    =  1;
    VALUE  args_for_returns[]  =  { rb_cObject };
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_returns,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchObjectReturnsNonNil( rb_method_match, rb_cObject, "methods" ) ) ) );    
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_returns->args_parsed );    
    SHOULD_EQUAL( rb_method_match, rb_cObject );
  END_IT
END_DESCRIBE
...
/*******************************************************************************
*  R_MatchObjectReturnsNonNilWithArgs( receiver, object, method, argc, args )  *
*******************************************************************************/

DESCRIBE( R_MatchObjectReturnsNonNilWithArgs, "R_MatchObjectReturnsNonNilWithArgs( receiver, object, method, argc, args )" )
  IT( "matches if named method returns returns non-nil when passed given args and assigns match to receiver" )
    VALUE  rb_self  =  rb_cObject;
    VALUE  argc    =  1;
    VALUE  rb_call_object  =  rb_ary_new();
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchObjectReturnsNonNilWithArgs( rb_method_returns_match, rb_call_object, "[]", 1, & rb_index ) ) ) );    
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_returns->args_parsed );    
    SHOULD_EQUAL( rb_method_returns_match, rb_call_object );
  END_IT
END_DESCRIBE
...
DESCRIBE( R_MatchHash, "R_MatchHash( receiver, key, data )" )
  IT( "matches hash for key and data and assigns match to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchHash(  rb_hash_match,
...
DESCRIBE( R_MatchHashKeyForHash, "R_MatchHashKeyForHash( receiver, possible_match, ... )" )
  IT( "check key in hash for possible match and if it matches, assign hash to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_Hash(  R_MatchHashKeyForHash( rb_hash_match, R_Symbol() ),
...
DESCRIBE( R_MatchIndexMatch, "R_MatchIndexMatch( receiver, index_string, possible_match )" )
  IT( "matches hash with index and tests corresponding data for possible_match, assigning match to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_hash,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchIndexMatch(  rb_hash_match, "key", R_Complex() ) ) ) );
...
DESCRIBE( R_MatchProc, "R_MatchProc( receiver )" )
  IT( "matches Proc and assigns to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_proc,    
                        rarg_parse_descriptor_for_proc,  
                        argc, 
                        args_for_proc,        
                        rb_self, 
                        FALSE, 
...
DESCRIBE( R_MatchLambda, "R_MatchLambda( receiver )" )
  IT( "matches Lambda and assigns to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_lambda,    
                        rarg_parse_descriptor_for_lambda,  
                        argc, 
                        args_for_lambda,        
                        rb_self, 
                        FALSE, 
...
DESCRIBE( R_MatchBlockProc, "R_MatchBlockProc( receiver )" )
  IT( "matches block and assigns to receiver as Proc" )
    ...
    RI_InitAndDefine(  RARG_macro_PossibleBlockMatch_parameter_set, 
                      RARG_macro_PossibleBlockMatch_parse_descriptor,  
                      0, 
                      NULL,  
                      rb_self, 
                      R_ParameterSet( R_Parameter( R_MatchBlockProc(  rb_block_match_arg ) ) ) );
...
DESCRIBE( R_MatchBlockLambda, "R_MatchBlockLambda( receiver )" )
  IT( "matches block and assigns to receiver as Lambda" )
    ...
    RI_InitAndDefine(  RARG_macro_PossibleBlockMatch_parameter_set, 
                      ...
                      NULL,  
                      rb_self, 
                      R_ParameterSet( R_Parameter( R_MatchBlockLambda(  rb_block_match_arg ) ) ) );
...
DESCRIBE( R_MatchBlockProcWithArity, "R_MatchBlockProcWithArity( receiver, arity, ... )" )
  IT( "matches block with one of given arities and assigns to receiver as Proc" )
    ...
    RI_InitAndDefine(  RARG_macro_PossibleBlockMatch_parameter_set, 
                      ...
                      NULL,  
                      rb_self, 
                      R_ParameterSet( R_Parameter( R_MatchBlockProcWithArity(  rb_block_match_arg, 1 ) ) ) );
...
DESCRIBE( R_MatchBlockLambdaWithArity, "R_MatchBlockLambdaWithArity( receiver, arity, ... )" )
  IT( "matches block with one of given arities and assigns to receiver as Proc" )
    ...
    RI_InitAndDefine(  RARG_macro_PossibleBlockMatch_parameter_set, 
                      ...
                      NULL,  
                      rb_self, 
                      R_ParameterSet( R_Parameter( R_MatchBlockLambdaWithArity(  rb_block_match_arg, 1 ) ) ) );
...
DESCRIBE( R_MatchAncestor, "R_MatchAncestor( receiver, class_or_module_name )" )
  IT( "checks whether arg has class_or_module_name as one of its ancestors and assigns match to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_ancestor,    
                        rarg_parse_descriptor_for_ancestor,  
                        argc, 
                        args_for_ancestor,    
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchAncestor(  rb_ancestor_match, "Object" ) ) ) );
...
DESCRIBE( R_MatchAncestorInstance, "R_MatchAncestorInstance( receiver, class_or_module_instance )" )
  IT( "checks whether arg has class_or_module_instance as one of its ancestors and assigns match to receiver" )
    ...
    RI_DefineAndParse(  rarg_parameter_sets_for_ancestor,    
                        ...
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_MatchAncestorInstance(  rb_ancestor_match, rb_cObject ) ) ) );
...
DESCRIBE( R_IfElse, "R_IfElse( possible_if_else_match, ... )" )
  IT( "checks for chain of if/else if/else statements" )
    ...
    VALUE  rb_symbol            =  ID2SYM( rb_str_new2( "symbol" ) );
    VALUE  args_for_if_match[]  =  { rb_string, rb_symbol };
    VALUE  rb_string_match      =  Qnil;
    VALUE  rb_symbol_match      =  Qnil;
    RI_DefineAndParse(  rarg_parameter_sets_for_if_match,    
                        rarg_parse_descriptor_for_if_match,  
                        argc, 
                        args_for_if_match,    
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_IfElse(  R_IfMatch(  R_MatchString( rb_string_match ),
                                                                            R_MatchSymbol( rb_symbol_match ) ) ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_if_match->args_parsed );
    SHOULD_EQUAL( rb_string_match, rb_string );
    SHOULD_EQUAL( rb_symbol_match, rb_symbol );

    //  if value => match
    VALUE  rb_predefined_value  =  Qtrue;
    rb_string_match      =  Qnil;
    rb_symbol_match      =  Qnil;
    RI_DefineAndParse(  rarg_parameter_sets_for_if_value,    
                        rarg_parse_descriptor_for_if_value,  
                        argc, 
                        args_for_if_match,    
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_IfElse(  R_IfValue(  rb_predefined_value,
                                                                            R_MatchString( rb_string_match ) ) ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_if_value->args_parsed );
    SHOULD_EQUAL( rb_string_match, rb_string );
    SHOULD_EQUAL( rb_symbol_match, Qnil );
    
    //  if match => else match
    VALUE  rb_string_if_match    =  Qnil;
    VALUE  rb_string_else_match  =  Qnil;
    VALUE  rb_symbol_if_match    =  Qnil;
    VALUE  rb_symbol_else_match  =  Qnil;
    RI_DefineAndParse(  rarg_parameter_sets_for_if_match_else_match,    
                        rarg_parse_descriptor_for_if_match_else_match,  
                        argc, 
                        args_for_if_match,    
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_IfElse(  R_IfMatch(  R_MatchSymbol( rb_string_if_match ),
                                                                            R_MatchSymbol( rb_symbol_if_match ) ),
                                                                R_Else(      R_MatchString( rb_string_else_match ) ) ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_if_match_else_match->args_parsed );
    SHOULD_EQUAL( rb_string_if_match, Qnil );
    SHOULD_EQUAL( rb_symbol_if_match, Qnil );
    SHOULD_EQUAL( rb_string_else_match, rb_string );
    SHOULD_EQUAL( rb_symbol_else_match, Qnil );

    //  if value => else match
    rb_string_if_match    =  Qnil;
    rb_string_else_match  =  Qnil;
    rb_symbol_if_match    =  Qnil;
    rb_symbol_else_match  =  Qnil;
    RI_DefineAndParse(  rarg_parameter_sets_for_if_value_else_match,    
                        rarg_parse_descriptor_for_if_value_else_match,  
                        argc, 
                        args_for_if_match,    
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_IfElse(  R_IfValue(  rb_predefined_value,
                                                                            R_MatchSymbol( rb_symbol_if_match ) ),
                                                                R_Else(      R_MatchString( rb_string_else_match ) ) ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_if_value_else_match->args_parsed );
    SHOULD_EQUAL( rb_string_if_match, Qnil );
    SHOULD_EQUAL( rb_symbol_if_match, Qnil );
    SHOULD_EQUAL( rb_string_else_match, rb_string );
    SHOULD_EQUAL( rb_symbol_else_match, Qnil );
    
    //  if match => else if match => match
    rb_string_if_match    =  Qnil;
    rb_string_else_match  =  Qnil;
    rb_symbol_if_match    =  Qnil;
    rb_symbol_else_match  =  Qnil;
    RI_DefineAndParse(  rarg_parameter_sets_for_if_match_else_if_match,    
                        rarg_parse_descriptor_for_if_match_else_if_match,  
                        argc, 
                        args_for_if_match,    
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_IfElse(  R_IfMatch(      R_MatchSymbol( rb_string_if_match ),
                                                                                R_MatchSymbol( rb_symbol_if_match ) ),
                                                                R_ElseIfMatch(  R_MatchString( rb_string_else_match ),
                                                                                R_MatchSymbol( rb_symbol_else_match ) ) ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_if_match_else_if_match->args_parsed );
    SHOULD_EQUAL( rb_string_if_match, Qnil );
    SHOULD_EQUAL( rb_symbol_if_match, Qnil );
    SHOULD_EQUAL( rb_string_else_match, rb_string );
    SHOULD_EQUAL( rb_symbol_else_match, rb_symbol );

    //  if match => else if value => match
    rb_string_if_match    =  Qnil;
    rb_string_else_match  =  Qnil;
    rb_symbol_if_match    =  Qnil;
    rb_symbol_else_match  =  Qnil;
    RI_DefineAndParse(  rarg_parameter_sets_for_if_match_else_value,    
                        rarg_parse_descriptor_for_if_match_else_value,  
                        argc, 
                        args_for_if_match,    
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_IfElse(  R_IfMatch(      R_MatchSymbol( rb_string_if_match ),
                                                                                R_MatchSymbol( rb_symbol_if_match ) ),
                                                                R_ElseIfValue(  rb_predefined_value,
                                                                                R_MatchString( rb_string_else_match ) ) ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_if_match_else_value->args_parsed );
    SHOULD_EQUAL( rb_string_if_match, Qnil );
    SHOULD_EQUAL( rb_symbol_if_match, Qnil );
    SHOULD_EQUAL( rb_string_else_match, rb_string );
    SHOULD_EQUAL( rb_symbol_else_match, Qnil );

    //  if value => else if match => match
    rb_string_if_match    =  Qnil;
    rb_string_else_match  =  Qnil;
    rb_symbol_if_match    =  Qnil;
    rb_symbol_else_match  =  Qnil;
    RI_DefineAndParse(  rarg_parameter_sets_for_if_value_else_if_match,    
                        rarg_parse_descriptor_for_if_value_else_if_match,  
                        argc, 
                        args_for_if_match,    
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_IfElse(  R_IfValue(      rb_predefined_value,
                                                                ...
                                                                R_ElseIfMatch(  R_MatchString( rb_string_else_match ),
                                                                                R_MatchSymbol( rb_symbol_else_match ) ) ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_if_value_else_if_match->args_parsed );
    SHOULD_EQUAL( rb_string_if_match, Qnil );
    SHOULD_EQUAL( rb_symbol_if_match, Qnil );
    SHOULD_EQUAL( rb_string_else_match, rb_string );
    SHOULD_EQUAL( rb_symbol_else_match, rb_symbol );

    //  if value => else if value => match
    VALUE  rb_value_nil  =  Qnil;
    rb_string_if_match    =  Qnil;
    rb_string_else_match  =  Qnil;
    rb_symbol_if_match    =  Qnil;
    rb_symbol_else_match  =  Qnil;
    RI_DefineAndParse(  rarg_parameter_sets_for_if_value_else_if_value,    
                        rarg_parse_descriptor_for_if_value_else_if_value,  
                        argc, 
                        args_for_if_match,    
                        rb_self, 
                        FALSE, 
                        R_ParameterSet( R_Parameter( R_IfElse(  R_IfValue(      rb_value_nil,
                                                                                R_MatchSymbol( rb_symbol_if_match ) ),
                                                                R_ElseIfValue(  rb_predefined_value,
                                                                                R_MatchString( rb_string_else_match ) ) ) ) ) );
    SHOULD_BE_TRUE( rarg_parse_descriptor_for_if_value_else_if_value->args_parsed );
    SHOULD_EQUAL( rb_string_if_match, Qnil );
    SHOULD_EQUAL( rb_symbol_if_match, Qnil );
    SHOULD_EQUAL( rb_string_else_match, rb_string );
    SHOULD_EQUAL( rb_symbol_else_match, Qnil );    
...
DESCRIBE( R_DefineAndParse, "R_DefineAndParse( argc, args, rb_self, parameter_set, ... )" )
  ...
  VALUE  rb_first_key        =  rb_str_new2( "key" );
  VALUE  rb_another_key      =  rb_str_new2( "another_key" );
  VALUE  rb_and_another_key  =  rb_str_new2( "and_another_key" );
  VALUE  args[]        =  { rb_first_key, rb_another_key, rb_and_another_key };
  int    argc          =  3;
  VALUE  rb_key        =  Qnil;
  VALUE  rb_index      =  Qnil;
  VALUE  rb_args_array  =  Qnil;
  VALUE  rb_hash_descriptor_index_key_or_keys_array  =  Qnil;
  R_DefineAndParse( argc, args, rb_self,
  ...
  SHOULD_BE_TRUE( rarg_parse_descriptor->args_parsed );
  SHOULD_EQUAL( rb_key, rb_first_key );
...
DESCRIBE( R_Arg, "R_Arg( rb_receiver )" )
  ...
  do {
    ...
    SHOULD_BE_TRUE( rb_key != Qnil );
    SHOULD_BE_TRUE(    rb_key == rb_first_key
                  ||  rb_key == rb_another_key
                  ||  rb_key == rb_and_another_key );
...
DESCRIBE( R_IterateArrayDescriptor, "R_IterateArrayDescriptor( rb_array, c_function )" )
  IT( "sends each element in the array back to the present function with optional args prepended" )
    ...
    R_DefineAndParse( argc, args, rb_self, R_ParameterSet( R_Parameter( R_MatchArray( rb_array_match ) ) ) );

    SHOULD_BE_TRUE( rarg_parse_descriptor->args_parsed );
    SHOULD_EQUAL( rb_array_match, rb_array );
...
void rb_Rargs_macro_spec( void )  {
  ...
  CSpec_Run( DESCRIPTION( R_MatchObjectRespondsTo ), CSpec_NewOutputVerbose() );
  CSpec_Run( DESCRIPTION( R_MatchObjectReturns ), CSpec_NewOutputVerbose() );
  CSpec_Run( DESCRIPTION( R_MatchObjectReturnsWithArgs ), CSpec_NewOutputVerbose() );
  CSpec_Run( DESCRIPTION( R_MatchObjectReturnsNonNil ), CSpec_NewOutputVerbose() );
  CSpec_Run( DESCRIPTION( R_MatchObjectReturnsNonNilWithArgs ), CSpec_NewOutputVerbose() );
  ...
  CSpec_Run( DESCRIPTION( R_IfElse ), CSpec_NewOutputVerbose() );
  CSpec_Run( DESCRIPTION( R_DefineAndParse ), CSpec_NewOutputVerbose() );
  CSpec_Run( DESCRIPTION( R_Arg ), CSpec_NewOutputVerbose() );
  CSpec_Run( DESCRIPTION( R_IterateArrayDescriptor ), CSpec_NewOutputVerbose() );
