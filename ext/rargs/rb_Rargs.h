	...
	***********************/
	...
	#define R_MatchKey( receiver, possible_match )													          R_MatchPossibleType( receiver, possible_match )
	#define R_MatchData( receiver, possible_match )													          R_MatchPossibleType( receiver, possible_match )
	#define R_MatchIndex( receiver, index_string )													          R_MatchPossibleType( receiver, R_Index( index_string ) )
	#define R_MatchIndexMatch( receiver, index_string, possible_match )								R_MatchPossibleType( receiver, R_IndexMatch( index_string, possible_match ) )
	...
	#define R_MatchMethodInstance( receiver )																          R_MatchPossibleType( receiver, R_Method() )
	...
	#define R_MatchGroup( receiver, possible_match, ... )															R_MatchPossibleType( receiver, R_Group( possible_match,##_VA_ARGS__ ) )

	#define R_MatchKeyForHash( receiver, possible_match, ... )												R_MatchPossibleTypeForHash( receiver, R_Key( possible_match,##__VA_ARGS__ ) )     
	#define R_MatchDataForHash( receiver, possible_match, ... )												R_MatchPossibleTypeForHash( receiver, R_Data( possible_match,##__VA_ARGS__ ) )
